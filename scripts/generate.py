...
DIALOGUE_SCRIPT = """
const CO_HOST_REACTIONS = ['โอ้โห น่าสนใจมากเลยค่ะ', 'ว้าว ข่าวนี้เด็ดเลย', 'น่าติดตามจริงๆ', 'อันนี้ห้ามพลาดเลยนะ'];
...
document.getElementById('dialogueListen')?.addEventListener('click', async (e) => {
  ...
  lines.push([`สวัสดีค่ะ ดิฉันพิธีกรจาก MEW Station ${title0}`, 1.0]);
  ...
  lines.push(['วันนี้ก็จบสรุปข่าวแค่นี้ค่ะ แล้วเจอกันใหม่', 1.0]);
